...
class SamsungReport:
    ...
    def remove_stopword(self):
        ...
        # print(stopwords[:30])
        # print('----------- 3 필터 --------')
        texts = [text for texts in tokens if text not in stopwords]
        # print(texts[:30])
        return texts
    ...
    def draw_wordcloud(self):
        texts = self.romove_stopword()
        wcloud = WordCloud('D2Coding.ttf', relative_scaling=0.2, background_color='white').generate(" ".join(texts))
